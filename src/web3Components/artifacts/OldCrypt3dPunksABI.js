const oldABI = [
  ...
  {
    inputs: [],
    name: "publicSaleMaxPerWallet",
    outputs: [{ internalType: "uint32", name: "", type: "uint32" }],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [{ internalType: "uint32", name: "count", type: "uint32" }],
    name: "publicSaleMint",
    outputs: [],
    stateMutability: "payable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "uint32", name: "end", type: "uint32" }],
    name: "setPreSaleEnd",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "uint32", name: "start", type: "uint32" }],
